...
try:
    import probability_theory_lib as ptl
...
def main():
    ...
    print("Answer: ", ptl.probability_bounds.markov_inequality_upperbound(0.3, 0.6))

    print("(b) Using Chebyshev's inequality")
    print("Answer: ", ptl.probability_bounds.chebyshev_inequality_upperbound(0.3, 0.6, 1))

    print("(c) Using Chernoff Bound")
    print("Answer: ", ptl.probability_bounds.chernoff_inequality_upperbound(0.3, 0.6, 1))
    
    # Problem 2: Random Load-Balancing
    print("\nProblem 2: Random Load-Balancing")
    print("Answer: ", ptl.load_balancing.random_load_balancing(10, 10000, 1200))
    
    # Problem 3: Sampling Theorem
    print("\nProblem 3: Sampling Theorem")
    print("Answer: ", ptl.sampling.samplingTheorem(0.05, 0.93))
    
    # Problem 4: 3SAT Problem
    print("\nProblem 4: 3SAT Problem")
    print("Answer: ", ptl.sat_problem.satisfying3SATProblem(100, 400, 0.5))
    
    # Problem 5: Entropy
    print("\nProblem 5: Entropy")
    print("(a) Compute and compare entropies of two biased 4-sided dice")
    print("Answer (i): ", ptl.entropy.entropyDice([1/2, 1/6, 1/6, 1/6]))
    print("Answer (ii): ", ptl.entropy.entropyDice([2/5,2/5,1/10,1/10]))
    print("Comparison of dice(i) versus dice(ii): ", ptl.entropy.compareEntropies(ptl.entropy.entropyDice([1/2, 1/6, 1/6, 1/6]), ptl.entropy.entropyDice([2/5,2/5,1/10,1/10]), 6))
    print("(b) Entropy of the random variable X")
    print("Answer: ", ptl.entropy.entropyOfSpecificValueForFairDice(6))
    ...
    print("Decision Tree: \n", ptl.decision_tree.id3GreedyAlgorithm(data))
